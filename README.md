...
The OTL lookups in Nutso apply the same layout to both the OTL <frac> and <afrc> features. In another font, <frac> could be reserved for diagonal fractions, and <afrc> used for nut fractions.
